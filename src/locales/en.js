export default {
  ...
  calories: "calories",
  of_protein: "of protein",
  of_fats: "of fats",
  of_carbohydrates: "of carbohydrates",
  privacy: "By continuing, you accept our terms of service and privacy policy.",
  and: "and",
  bmi_title: "What is BMI?",
  bmi_text: "BMI is a rough indicator that gives a weight range that it believes to be healthy based on your current weight and height. Based on your muscle mass and other factors, you can be in perfect health even if your weight is outside the range given by BMI.",
  status_0: "Canceled",
  status_1: "Active",
  status_2: "Paused",
  status_3: "Not Started",
  status_4: "Resumed",
  whats_your_email: "What’s your email?",
  whats_phone: "What’s your phone number?",
  calc_error: "We apologise! Your input is outside the range that we built into our calculator. Please check the input or get in touch with us at: info@calori.fi",
  back_home: "Take me back",
  bmiErrorFrase: "Unfortunately, we cannot promise a balanced diet and results. Would you leave your email address or phone number, so we can contact you personally within 1-2 business days? Thank you for your patience!",
  allergyErrorFrase: `Hi👋Before we know for sure that we can make your meal plan, we’d love to get in touch and learn more about you.🙌`,
  anotherAllergyErrorFrase: `Hi 👋 Before we know for sure that we can make your meal plan, please tell us more about your dietary restrictions.`,
  ...
  MealPrepForProductivity_how_works_2_text: "Tired of cooking or re-ordering? Let us take care of everything: from balanced nutrition to chef-crafted meals and home deliveries.",
  ...
  /* WeightLoss */
  WeightLoss_title: "Weight loss without cooking, counting calories, and working out",
  WeightLoss_text: "Just subscribe and start reaching your goals. We'll take care of the rest.",
  WeightLoss_card_1_title: "Find out when you’ll hit your goal",
  WeightLoss_card_1_text: "JJust answer a few short questions (it won't take more than 2 minutes) and see when the date when you can reach your target weight.",
  ...
  WeightLoss_card_3_text: "Get home deliveries twice a week with 4-5 amazing and healthy meals for you to enjoy every day.",
  WeightLoss_card_4_title: "Keep us in the loop",
  WeightLoss_card_4_text: "Send us short updates every week. We'll track your progress and give you much-needed motivation boosts!",
  WeightLoss_card_5_title: "Eat, enjoy, and see the difference",
  WeightLoss_card_5_text: "Just relax, enjoy your new life, and make progress even if you don't hit the gym. It's that simple!",
  ...
  WeightLoss_list_item_5: "Working out? Only if you're up for it",
  ...
  WeightLoss_plus_2_title: "Over 10 days",
  WeightLoss_plus_2_text: "saved on planning, shopping, cooking, and cleaning. (+240 hours)",
  ...
  /* HealthyEating */
  Healthy_123: "Learn more 👇",
  HealthyEating_title: "Healthy eating made simple and delicious ✨",
  HealthyEating_text: "We design personal meal plans just for your needs. And next, we cook and deliver all the meals you need in a day.",
  ...
  HealthyEating_what_is_1: 'Staying on track and reaching your goals can be difficult. <br><br>  Planning, shopping, cooking, and cleaning can take most of your time and energy.<br><br>  And after all, you’re still not sure if you’re eating right…',
  HealthyEating_what_is_2: "Eating healthy can be easy, fun, and delicious. <br><br>  We help you get the perfect balance of nutrients, save time, and keep you energized through long, busy days.",
  HealthyEating_what_is_3: `Take a short quiz and find out exactly what your body needs. 
  <br><br>
Our team of professional nutritionists spent years crafting meal plans that combine healthy with tasty. And now, we made it accessible to you through Calori.`,
  HealthyEating_what_is_4: "Get all meals you need in a day delivered to your home. <br><br>  Our chefs turned complex plans into delicious meals - hitting the perfect balance between home-made and sporty. You can enjoy restaurant-level breakfast, lunch, dinner, and snacks everywhere you go.",
  HealthyEating_what_is_5: `Staying on track and finding motivation is never easy without a support system.
  <br><br>
  ...
  HealthyEating_before_calori_text: "It’s time to say goodbye to the old ways that never worked for you.",
  HealthyEating_after_calori_title: "After Calori",
  HealthyEating_after_calori_text: "You can be confident in your health and choices.",
  reviews_block_title_healthy: "Customer stories",
  reviews_block_text_healthy: "Our pre-launch group has grown into a community of just over 70 customers. Here's what they say about their journeys with Calori:",
  ...
  HealthyEating_list_item_5: "Stressing about not eating well",
  ...
  healthy_contact_form_title: "We’ll be thrilled to answer them!",
  /* HealthyEating */
  ...
  how_works_2_text_home: "Get all meals you need in a day delivered to your home.   <br><br>Our chefs turned complex plans into delicious meals - hitting the perfect balance between home-made and sporty. You can enjoy restaurant-level breakfast, lunch, dinner, and snacks everywhere you go.",
  ...
  send_new_password: "Reset password",
  ...
  menu_text_before_healthy: "Find out what the perfect diet looks like for you! <br><br>With Calori, you’ll get balanced meals cooked and delivered according to your personalized plan. That’s 140+ unique meals in 1 month.",
  ...
  green_label_text: "Launching in Helsinki, Espoo, Vantaa on 8.1.2024",
  ...
  check17frase: "Almost there!",
  button_quiz_send: "Get your personal meal plan",
  /* ТРЕТЬЯ ПАРТИЯ ЛОКАЛЕЙ */
